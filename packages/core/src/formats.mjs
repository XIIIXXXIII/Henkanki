...
export const formats = Object.freeze([
  ...
  entry('svg', ['svg'], 'image/svg+xml', 'image', 'experimental'),
  entry('heic', ['heic'], 'image/heic', 'image', 'experimental'),
  entry('heif', ['heif', 'hif'], 'image/heif', 'image', 'experimental'),
  ...
  entry('aac', ['aac'], 'audio/aac', 'media', 'supported'),
  entry('opus', ['opus'], 'audio/ogg', 'media', 'supported'),
  entry('aiff', ['aif', 'aiff'], 'audio/aiff', 'media', 'supported'),
  ...
  entry('3gp', ['3gp'], 'video/3gpp', 'media', 'supported'),
  entry('mpeg', ['mpg', 'mpeg'], 'video/mpeg', 'media', 'supported'),
  entry('ts', ['ts', 'm2ts'], 'video/mp2t', 'media', 'supported'),
